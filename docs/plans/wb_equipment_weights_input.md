# W&B Equipment List: Weight Input

Fill in the **Weight (lbs)** and **Source** columns. Use installed weight (unit + mounting hardware + connectors) where available.
Delete any row that should not appear in the published equipment list.

When done, save the file — Architect will pick it up to create the Writer task.
