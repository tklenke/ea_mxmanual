...
> - **Writer**: User Interviewing and clarification, Research, Implementation
> - **Reviewer**: Quality review, standards compliance
>
...
- After completing architectural work: "Should I switch to Writer role to implement this?"
- After implementation: "Should I switch to Reviewer role to review this?"
...
- We discuss architectural decisions (standards changes, structural decisions: TOC changes, major reorganization, content scope.)
  together before implementation. Routine edits and clear writing tasks don't need
  discussion.
